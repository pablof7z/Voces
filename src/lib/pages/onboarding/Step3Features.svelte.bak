...
<div class="min-h-screen flex items-center justify-center p-8 py-16">
  <div class="max-w-5xl w-full">
    ...
    <div class="grid md:grid-cols-3 gap-6 mb-12">
      <!-- Marketplace -->
      <div class="bg-neutral-50 dark:bg-neutral-900 rounded-xl p-6 border border-neutral-200 dark:border-neutral-800">
        ...
        <div class="bg-white dark:bg-black rounded-lg p-4 text-left border border-neutral-200 dark:border-neutral-800">
          <div class="flex items-center gap-2 mb-2">
            <div class="w-8 h-8 bg-neutral-300 dark:bg-neutral-700 rounded-full flex items-center justify-center text-xs font-medium">
              MR
            </div>
            <div class="flex-1 min-w-0">
              <div class="font-semibold text-sm truncate">María's Bakery</div>
              <div class="text-xs text-neutral-500">2km away</div>
            </div>
          </div>
      ...
      <div class="bg-neutral-50 dark:bg-neutral-900 rounded-xl p-6 border border-neutral-200 dark:border-neutral-800">
        ...
        <div class="bg-white dark:bg-black rounded-lg p-4 border border-neutral-200 dark:border-neutral-800">
          <div class="space-y-2">
          ...
          <div class="flex items-center justify-center gap-1 text-xs text-neutral-500 mt-3">
    ...
    <div class="text-center">
      <button
        onclick={onNext}
        class="bg-black dark:bg-white text-white dark:text-black px-8 py-3 rounded-lg font-medium hover:bg-neutral-800 dark:hover:bg-neutral-200 transition-colors"
      >
        Continue →
      </button>
    </div>
