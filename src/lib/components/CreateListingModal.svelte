...
{#if open}
  ...
  >
    <div
      class="w-full max-w-4xl mx-4 bg-card rounded-2xl border border-border shadow-2xl my-auto"
                ...
                {#each images as image, index}
                  <div class="relative group">
                    ...
                    <button
                      ...
                      class="absolute top-2 right-2 p-1 bg-red-500 text-foreground rounded-full opacity-0 group-hover:opacity-100 transition-opacity"
                    >
