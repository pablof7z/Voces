<script lang="ts">
  ...
  const { isOpen, onClose, pubkey, npub }: Props = $props();
...
{#if isOpen}
  <div class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-background/50" onclick={onClose}>
    <div class="bg-card rounded-2xl max-w-md w-full relative" onclick={(e) => e.stopPropagation()}>
      <button
        onclick={onClose}
      ...
      <div class="p-6">
        <h2 class="text-xl font-bold text-center mb-6">Share Profile</h2>

        <div class="bg-gradient-to-br from-orange-500 to-red-500 rounded-xl p-6 mb-6">
        ...
        <div class="space-y-3 mb-6">
          <button
            ...
            class="w-full flex items-center justify-between px-4 py-3 bg-muted hover:bg-muted rounded-lg transition-colors"
          >
        ...
        <div class="space-y-2">
          <p class="text-sm text-muted-foreground mb-3">Share on:</p>
          <div class="grid grid-cols-2 gap-3">
            <button
              onclick={() => shareOnPlatform('whatsapp')}
              class="flex items-center justify-center gap-2 px-4 py-3 bg-green-500 hover:bg-green-600 text-foreground rounded-lg transition-colors"
            >
            ...
            <button
              ...
              class="flex items-center justify-center gap-2 px-4 py-3 bg-background hover:bg-card text-foreground rounded-lg transition-colors"
            >
              <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
            ...
            <button
              ...
              class="flex items-center justify-center gap-2 px-4 py-3 bg-blue-500 hover:bg-blue-600 text-foreground rounded-lg transition-colors"
            >
              <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
            ...
            <button
              ...
              class="flex items-center justify-center gap-2 px-4 py-3 bg-blue-600 hover:bg-blue-700 text-foreground rounded-lg transition-colors"
            >
              <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
