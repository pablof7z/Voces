    ...
    >
      ...
      <div class="flex items-start justify-between mb-4">
        <div class="flex items-center gap-3">
          ...
          <div>
            <h2 class="text-xl font-bold text-neutral-900 dark:text-foreground">Relay Authentication</h2>
          </div>
        </div>
        <button
          onclick={handleClose}
          class="text-muted-foreground hover:text-neutral-900 dark:hover:text-foreground transition-colors"
      ...
      <!-- Content -->
      <div class="mb-6">
        <p class="text-neutral-700 dark:text-muted-foreground mb-2">
          The relay <strong class="font-semibold text-neutral-900 dark:text-foreground">{relayAuthModal.request.relayUrl}</strong> is requesting authentication.
        </p>
