    ...
    >
      ...
      <div class="relative px-6 py-6 border-b border-purple-600/20 bg-gradient-to-r from-purple-900/20 to-pink-900/20">
        ...
        <div class="relative flex items-center justify-between">
          <div class="flex items-center gap-3">
            ...
            <div>
              <h2 class="text-xl font-bold text-white">Zap Amount</h2>
      ...
      <div class="p-6 space-y-6">
          ...
          {#each amounts as amount}
            ...
            >
              ...
              <div class="relative flex flex-col items-center gap-2">
                ...
                <span class="text-xs font-bold text-white">{amount.label}</span>
              </div>
            </button>
          {/each}
        </div>
        ...
        <div class="space-y-2">
          ...
          <div class="relative">
            <input
              ...
              class="w-full px-4 py-4 bg-gradient-to-br from-neutral-800 to-neutral-900 border-2 {isCustom ? 'border-purple-600' : 'border-neutral-700'} rounded-2xl text-white placeholder-neutral-500 focus:outline-none focus:border-purple-600 transition-colors text-lg font-semibold"
            />
            <div class="absolute right-4 top-1/2 -translate-y-1/2 text-neutral-400 font-semibold">
              sats
            </div>
          </div>
        </div>
        ...
        <div class="flex gap-3">
          <button
            onclick={onCancel}
            class="flex-1 px-6 py-4 rounded-2xl bg-gradient-to-br from-neutral-800 to-neutral-900 hover:from-neutral-700 hover:to-neutral-800 text-white font-semibold transition-all"
            type="button"
          >
            Cancel
          </button>
          <button
            ...
            class="flex-1 px-6 py-4 rounded-2xl bg-gradient-to-br from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 disabled:from-neutral-700 disabled:to-neutral-800 disabled:cursor-not-allowed text-white font-bold shadow-lg shadow-purple-600/50 hover:shadow-purple-600/70 transition-all disabled:shadow-none flex items-center justify-center gap-2"
            type="button"
          >
