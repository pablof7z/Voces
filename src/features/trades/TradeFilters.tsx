      ...
      <div>
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="w-full px-2 py-2 border border-neutral-300 dark:border-neutral-700 rounded-lg bg-white dark:bg-black text-neutral-900 dark:text-white text-sm"
            placeholder="Min"
          />
