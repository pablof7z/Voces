export const ARTICLE_STYLES = {
  ...
  INPUT_BASE: 'w-full p-4 bg-neutral-50 dark:bg-black border border-gray-200 dark:border-gray-700 rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-accent-500',
  PROSE_STYLES: 'prose prose-lg prose-neutral dark:prose-invert max-w-none prose-headings:font-serif prose-headings:font-bold prose-p:font-serif prose-p:text-gray-800 dark:prose-p:text-gray-200 prose-p:leading-relaxed prose-p:text-lg prose-a:text-accent-600 dark:prose-a:text-accent-400 prose-a:no-underline hover:prose-a:underline prose-blockquote:border-l-accent-500 prose-blockquote:font-serif prose-blockquote:italic prose-pre:bg-neutral-100 dark:prose-pre:bg-black prose-pre:border prose-pre:border-gray-200 dark:prose-pre:border-gray-800',
} as const;