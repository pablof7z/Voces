    ...
    <div className="bg-white border rounded-lg p-4 mb-4">
        <div className="flex items-center mb-2">
            ...
            <div>
                ...
                <p className="text-sm text-neutral-500">@{post.author.nip05}</p>
            </div>
        </div>
  ...
  return (
    <div>
        <div className="mb-6">
            ...
            <p className="text-neutral-600 text-center mb-4">Create your first post. Here are some great examples from the community:</p>
        ...
        />
        <p className="text-xs text-neutral-500 mt-2">Your inviter will be tagged automatically so they can welcome you!</p>
    </div>
  );
}