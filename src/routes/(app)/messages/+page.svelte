  ...
  <div class="h-full flex flex-col">
    ...
    <div class="sticky top-0 z-10 bg-black border-b border-neutral-800/50 px-4 py-3">
      <div class="flex items-center justify-between">
        ...
        <button class="p-2 rounded-lg hover:bg-neutral-800/50 transition-colors text-neutral-400 hover:text-orange-500">
      ...
      <div class="mb-6 flex justify-center">
        <div class="relative">
          ...
          <div class="absolute inset-0 flex items-center justify-center">
            <div class="w-24 h-24 rounded-full bg-orange-500/20 animate-ping"></div>
          </div>
        </div>
      </div>
