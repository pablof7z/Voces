      ...
      <div className="max-w-2xl w-full text-center">
        ...
        <div className="grid grid-cols-3 gap-4 max-w-lg mx-auto mb-12">
          <div className="bg-neutral-50 dark:bg-neutral-900 rounded-xl p-6">
            ...
            <div className="text-sm text-neutral-500">People Following</div>
          </div>
          <div className="bg-neutral-50 dark:bg-neutral-900 rounded-xl p-6">
            <div className="text-3xl font-bold mb-1">{selectedPacks.length}</div>
            <div className="text-sm text-neutral-500">Follow Packs</div>
          </div>
          <div className="bg-neutral-50 dark:bg-neutral-900 rounded-xl p-6">
            <div className="text-3xl font-bold mb-1">1</div>
            <div className="text-sm text-neutral-500">Post Published</div>
          </div>
        </div>

        {/* What's next */}
        <div className="bg-gradient-to-br from-neutral-50 to-neutral-100 dark:from-neutral-900 dark:to-neutral-800 rounded-xl p-8 mb-8 text-left max-w-lg mx-auto">
