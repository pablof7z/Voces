...
export function TradePage() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-black">
      {/* Header */}
      <div className="bg-white dark:bg-black border-b border-neutral-200 dark:border-neutral-800 sticky top-0 z-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 md:py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-lg md:text-2xl font-bold text-neutral-900 dark:text-white">P2P Trading</h1>
              <p className="text-xs md:text-sm text-neutral-500 dark:text-neutral-400 mt-0.5 md:mt-1 hidden sm:block">
            ...
            {currentUser && (
              <button
                ...
                className="hidden md:flex items-center gap-2 px-3 md:px-4 py-1.5 md:py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-colors text-sm md:text-base"
              >
